...
## A split adatsort részekre bontja és elhejezni egy szöveges tuple-ben.
## Csillag operátor a tuple-t felosztja és hpzzáadja a megfelelő paraméterekhez


#3
print(f"K = {har.Kerulet:.2f}")
print(f"K = {har2.Kerulet:.2f}")
print(f"K = {har3.Kerulet:.2f}")
print(f"K = {har4.Kerulet:.2f}")
print()

print(f"T = {har4.Terulet:.2f}")
print(f"ma = {har.MagassagA:.2f}")
print(f"mb = {har.MagassagB:.2f}")
print(f"mc = {har.MagassagC:.2f}")

print(f"alfa = {har.Alfa:.2f}")
print(f"betta = {har.Betta:.2f}")
print(f"gamma = {har.Gamma:.2f}")